...
```bash
# macOS / Linux (bash)
curl -fsSL https://raw.githubusercontent.com/guuguo/stock-skills/main/install.sh | bash
```

```powershell
# Windows (PowerShell, 需管理员权限)
irm https://raw.githubusercontent.com/guuguo/stock-skills/main/install.ps1 | iex
```
